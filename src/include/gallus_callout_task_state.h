 ...
 * $__Copyright__$
 */
#ifndef __GALLUS_CALLOUT_TASK_STATE_H__
#define __GALLUS_CALLOUT_TASK_STATE_H__
...
/**
 *	@file	gallus_callout_task_state.h
 */
...
typedef callout_task_state_t	gallus_callout_task_state_t;
