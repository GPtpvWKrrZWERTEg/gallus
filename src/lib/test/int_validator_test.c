...
#define checkOOR(r)                                     \
  do {                                                  \
    if (r != GALLUS_RESULT_OUT_OF_RANGE) {             \
      gallus_perror(r);                                \
    }                                                   \
    TEST_ASSERT_EQUAL(r, GALLUS_RESULT_OUT_OF_RANGE);  \
  } while (0)
...
test_16_range_valid(void) {
   ...
   * uint16_t valid:
   */
  r = gallus_str_parse_uint16(s_u16_max_str, &u16);
  checkOK(r);
  u16out(u16, (uint16_t)s_u16_max);
  TEST_ASSERT_EQUAL(u16, (uint16_t)s_u16_max);
  r = gallus_str_parse_uint16(s_i16_max_str, &u16);
  checkOK(r);
   ...
   * int16_t valid:
   */
  r = gallus_str_parse_int16(s_i16_max_str, &i16);
  checkOK(r);
  i16out(i16, (int16_t)s_i16_max);
  TEST_ASSERT_EQUAL(i16, (int16_t)s_i16_max);
  r = gallus_str_parse_int16(s_i16_min_str, &i16);
  checkOK(r);
...
test_16_range_invalid(void) {
   ...
   * uint16_t invalid:
   */
  r = gallus_str_parse_uint16(s_u128_max_str, &u16);
  checkOOR(r);

  r = gallus_str_parse_uint16(s_u64_max_str, &u16);
  checkOOR(r);
  r = gallus_str_parse_uint16(s_i64_max_str, &u16);
  checkOOR(r);
  r = gallus_str_parse_uint16(s_i64_min_str, &u16);
  checkOOR(r);

  r = gallus_str_parse_uint16(s_u32_max_str, &u16);
  checkOOR(r);
  r = gallus_str_parse_uint16(s_i32_max_str, &u16);
  checkOOR(r);
  r = gallus_str_parse_uint16(s_i32_min_str, &u16);
  checkOOR(r);

  r = gallus_str_parse_uint16(s_i16_min_str, &u16);
  checkOOR(r);

  /*
   * int16_t invalid:
   */
  r = gallus_str_parse_int16(s_u128_max_str, &i16);
  checkOOR(r);

  r = gallus_str_parse_int16(s_u64_max_str, &i16);
  checkOOR(r);
  r = gallus_str_parse_int16(s_i64_max_str, &i16);
  checkOOR(r);
  r = gallus_str_parse_int16(s_i64_min_str, &i16);
  checkOOR(r);

  r = gallus_str_parse_int16(s_u32_max_str, &i16);
  checkOOR(r);
  r = gallus_str_parse_int16(s_i32_max_str, &i16);
  checkOOR(r);
  r = gallus_str_parse_int16(s_i32_min_str, &i16);
  checkOOR(r);

  r = gallus_str_parse_int16(s_u16_max_str, &i16);
  checkOOR(r);
}
...
test_32_range_invalid(void) {
   ...
   * uint32_t invalid:
   */
  r = gallus_str_parse_uint32(s_u128_max_str, &u32);
  checkOOR(r);

  r = gallus_str_parse_uint32(s_u64_max_str, &u32);
  checkOOR(r);
  r = gallus_str_parse_uint32(s_i64_max_str, &u32);
  checkOOR(r);
  r = gallus_str_parse_uint32(s_i64_min_str, &u32);
  checkOOR(r);

  r = gallus_str_parse_uint32(s_i32_min_str, &u32);
  checkOOR(r);

  r = gallus_str_parse_uint32(s_i16_min_str, &u32);
  checkOOR(r);

  /*
   * int32_t invalid:
   */
  r = gallus_str_parse_int32(s_u128_max_str, &i32);
  checkOOR(r);

  r = gallus_str_parse_int32(s_u64_max_str, &i32);
  checkOOR(r);
  r = gallus_str_parse_int32(s_i64_max_str, &i32);
  checkOOR(r);
  r = gallus_str_parse_int32(s_i64_min_str, &i32);
  checkOOR(r);

  r = gallus_str_parse_int32(s_u32_max_str, &i32);
  checkOOR(r);
}
...
test_64_range_invalid(void) {
   ...
   * uint64_t invalid:
   */
  r = gallus_str_parse_uint64(s_u128_max_str, &u64);
  checkOOR(r);

  r = gallus_str_parse_uint64(s_i64_min_str, &u64);
  checkOOR(r);

  r = gallus_str_parse_uint64(s_i32_min_str, &u64);
  checkOOR(r);

  r = gallus_str_parse_uint64(s_i16_min_str, &u64);
  checkOOR(r);

  /*
   * int64_t invalid:
   */
  r = gallus_str_parse_int64(s_u128_max_str, &i64);
  checkOOR(r);

  r = gallus_str_parse_int64(s_u64_max_str, &i64);
  checkOOR(r);
}
